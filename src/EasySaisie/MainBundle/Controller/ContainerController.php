...
namespace EasySaisie\MainBundle\Controller;
...
use EasySaisie\MainBundle\Entity\Container;
use EasySaisie\MainBundle\Form\ContainerType;
...
class ContainerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EasySaisieMainBundle:Container')->findAll();
     ...
     * @Method("POST")
     * @Template("EasySaisieMainBundle:Container:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EasySaisieMainBundle:Container')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EasySaisieMainBundle:Container:edit.html.twig")
     */
