...
use C2J\EasySaisieBundle\Form\RuleType;
...
class RuleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('C2JEasySaisieBundle:Rule')->findAll();
     ...
     * @Method("POST")
     * @Template("C2JEasySaisieBundle:Rule:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('C2JEasySaisieBundle:Rule')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("C2JEasySaisieBundle:Rule:edit.html.twig")
     */
